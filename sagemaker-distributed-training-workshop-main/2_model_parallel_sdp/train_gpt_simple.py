...
def train(
    ...
    train_paths = sorted( [os.path.join(args.training_dir, p) for p in os.listdir(args.training_dir)])
    ...
    if args.validation_freq is not None:
        ...
        val_paths = sorted([os.path.join(args.test_dir, p) for p in os.listdir(args.test_dir)])
